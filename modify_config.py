...
for old_file in old_configs:
    if os.path.basename(old_file) != output_filename:
        try:
            ...
            trap_json = {
                "spider": "", 
                "notice": "⚠️ 警告：当前老杨TV全量专线密锁已过期断流！老链接已彻底作废！\n\n请立刻打开手机微信进入【老杨官方核心铁粉群】查看公告，获取今日最新 3 位后缀通关密码！退群、失联将永久断流无法观看！",
                "warningText": "👑 特别提示：当前全量专线已断流！请看下方线路名称提示！回微信群拿最新3位密码！",
                "sites": [
                    {
                        "key": "老杨纯文字提示",
                        "name": "🚨 密锁已过期 ➡️ 进微信群获取今日最新 3 位密码",
                        "type": 3,
                        "api": "csp_JuDou",
                        "searchable": 0,
                        "quickSearch": 0,
